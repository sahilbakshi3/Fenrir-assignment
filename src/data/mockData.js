...
export const scans = [
  ...
  },
  {
    ...
    status: "Completed",
    progress: 100,
    vuln: { critical: 7, high: 9, medium: 4, low: 2 },
    lastScan: "6d ago",
  },
  {
    id: 3,
    ...
    status: "Completed",
    progress: 100,
    vuln: { critical: 3, high: 7, medium: 15, low: 9 },
    lastScan: "2d ago",
  },
  {
    id: 4,
    ...
    status: "Completed",
    progress: 100,
    vuln: { critical: 0, high: 2, medium: 11, low: 22 },
    lastScan: "5d ago",
  },
  {
    id: 5,
    ...
    status: "Completed",
    progress: 100,
    vuln: { critical: 9, high: 14, medium: 6, low: 3 },
    lastScan: "1d ago",
  },
  {
    id: 6,
    ...
    status: "Completed",
    progress: 100,
    vuln: { critical: 2, high: 5, medium: 18, low: 31 },
    lastScan: "3d ago",
  },
  {
    id: 7,
    ...
    status: "Completed",
    progress: 100,
    vuln: { critical: 0, high: 1, medium: 7, low: 14 },
    lastScan: "7d ago",
  },
  {
    id: 8,
    ...
    status: "Completed",
    progress: 100,
    vuln: { critical: 4, high: 8, medium: 12, low: 5 },
    lastScan: "2d ago",
  },
  {
    id: 9,
  ...
  },
  {
    ...
    status: "Failed",
    progress: 12,
    vuln: { critical: 2, high: 4, medium: 8, low: 1 },
    lastScan: "3d ago",
  },
  {
    id: 13,
    ...
    status: "Failed",
    progress: 8,
    vuln: { critical: 1, high: 2, medium: 3, low: 0 },
    lastScan: "5d ago",
  },
  {
    id: 14,
    ...
    status: "Failed",
    progress: 37,
    vuln: { critical: 6, high: 11, medium: 9, low: 4 },
    lastScan: "9d ago",
  },
  {
    id: 15,
    ...
    status: "Completed",
    progress: 100,
    vuln: { critical: 1, high: 3, medium: 22, low: 17 },
    lastScan: "4d ago",
  },
  {
    id: 16,
    ...
    status: "Completed",
    progress: 100,
    vuln: { critical: 0, high: 6, medium: 9, low: 28 },
    lastScan: "2d ago",
  },
  {
    id: 17,
    ...
    status: "Completed",
    progress: 100,
    vuln: { critical: 3, high: 5, medium: 14, low: 11 },
    lastScan: "6d ago",
  },
  {
    id: 18,
  ...
  },
  {
    ...
    status: "Completed",
    progress: 100,
    vuln: { critical: 0, high: 1, medium: 5, low: 9 },
    lastScan: "11d ago",
  },
  {
    id: 20,
    ...
    status: "Failed",
    progress: 55,
    vuln: { critical: 8, high: 13, medium: 7, low: 2 },
    lastScan: "1d ago",
  },
  {
    id: 21,
    ...
    status: "Completed",
    progress: 100,
    vuln: { critical: 4, high: 9, medium: 16, low: 7 },
    lastScan: "3d ago",
  },
  {
    id: 22,
    ...
    status: "Completed",
    progress: 100,
    vuln: { critical: 0, high: 0, medium: 3, low: 12 },
    lastScan: "5d ago",
  },
  {
    id: 23,
  ...
  },
  {
    ...
    status: "Completed",
    progress: 100,
    vuln: { critical: 2, high: 4, medium: 8, low: 6 },
    lastScan: "7d ago",
  },
  {
    id: 25,
    ...
    status: "Completed",
    progress: 100,
    vuln: { critical: 11, high: 7, medium: 2, low: 1 },
    lastScan: "2d ago",
  },
  {
    id: 26,
    ...
    status: "Completed",
    progress: 100,
    vuln: { critical: 1, high: 3, medium: 9, low: 15 },
    lastScan: "4d ago",
  },
  {
    id: 27,
    ...
    status: "Failed",
    progress: 22,
    vuln: { critical: 5, high: 9, medium: 4, low: 0 },
    lastScan: "6d ago",
  },
  {
    id: 28,
    ...
    status: "Completed",
    progress: 100,
    vuln: { critical: 0, high: 2, medium: 6, low: 19 },
    lastScan: "8d ago",
  },
];
...
export const verificationLogs = [
  {
    id: 1,
    time: "09:10:00",
    text: "Starting verification loop for SQL injection findings...",
  },
  {
    id: 2,
    time: "09:11:00",
    text: "Confirmed: payload `' OR 1=1--` returns 200 with all users listed.",
    highlights: [{ text: "' OR 1=1--", type: "path" }],
  },
  {
    id: 3,
    time: "09:12:00",
    text: "Time-based blind injection verified. Response delay: 5.2s with SLEEP(5).",
  },
  {
    id: 4,
    time: "09:13:00",
    text: "IDOR validation: Accessed user IDs 10001 through 10050 successfully.",
    highlights: [{ text: "10001 through 10050", type: "url" }],
  },
  {
    id: 5,
    time: "09:14:00",
    text: "Rate limit bypass confirmed. 500 requests/minute with no throttling detected.",
  },
];
...
export const findings = [
  ...
  },
  {
    ...
    description:
      "User-supplied input in the search parameter is reflected without sanitization, allowing script execution.",
  },
  {
    id: 5,
    severity: "Low",
    ...
    description:
      "Stack traces and internal paths are returned in 500 error responses, leaking implementation details.",
  },
];
